    ...
    <div className="bg-[#FEFAE0] ">
      ...
      >
        <div className="h-full max-w-7xl flex flex-col m-auto justify-center items-center overflow-auto">
          <p className="font-semibold text-3xl pt-16">Meet Our Specialists</p>
            ...
            <div className="flex gap-3 ">
              ...
              <div className="w-[270px] h-[300px] bg-[#D4A373] border border-gray-200 rounded-lg shadow flex justify-center">
                <div className="flex flex-col items-center justify-center ">
                  ...
                  <span className="text-sm text-black">Gynaecologist</span>
                  <div className="flex mt-4 md:mt-6">
                    <a
                      href="/appointment"
                      className="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-gray-900 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-700 dark:focus:ring-gray-700 ms-3"
            ...
            <div className="flex gap-3">
              ...
              <div className="w-[270px] h-[300px] bg-[#D4A373] border border-gray-200 rounded-lg shadow flex justify-center">
                <div className="flex flex-col items-center justify-center ">
                  ...
                  <span className="text-sm text-black">Ophthalmologist</span>
                  <div className="flex mt-4 md:mt-6">
                    <a
                      href="/appointment"
                      className="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-gray-900 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-700 dark:focus:ring-gray-700 ms-3"
        ...
        <div className=" max-w-7xl m-auto flex flex-col justify-center gap-8 items-center w-full h-full overflow-auto ">
          ...
          >
            ...
            <div className="flex flex-col items-start py-5 p-5 w-[450px] shadow-xl bg-[#E9EDC9] shadow-violet-400 rounded-lg">
              ...
              <div>
                <p className="">
                  I have visited many hospitals but True Care Hospital has to be
                ...
                <p>
                  {" "}
                  I would highly recommend True Care Hospital to all. Once again
            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
              <div className="w-full md:w-2/3 lg:w-1/2">
                ...
                <p className="mt-4 text-gray-600">
                  Be sure to check out and subscribe to the newsletters of True
                  Care Hospital to stay updated about the developments in
                  healthcare field.
                </p>
                <div className="mt-4">
